...
<h3><a href="gclusters.altervista.org">
...
<tr>
<td width="40%">Name of the cluster:</td>
<td width="60%"> <input type=text size=30 name="cluster">
</td>
</tr>

<tr>
<td width="40%">Author(s) of the paper:</td>
<td width="60%">
...
<td width="60%">
<textarea cols=22 name="titolo" rows=3>
</textarea></td>
</tr>

<tr>
<td width="40%">Journal:</td>
<td width="60%">
