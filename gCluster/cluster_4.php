...
echo "</HEAD>\n";
echo "<BODY background=\"static/images/backgr2.jpg\" TEXT=\"#0000FF\" LINK=\"#0000FF\" VLINK=\"#A020F0\" ALINK=\"#FF0000\">\n";
include 'inte2.php';
...
{
echo '<tr><td align=center>';
echo "<img src=\"static/images/new_anim.gif\">";
...
if ($numerloc){
echo '<tr><td><img src="static/images/new_anim.gif">Listen to <i>the sound</i> of this cluster (<a href="soundclusters.php">info</a>)<br>';
