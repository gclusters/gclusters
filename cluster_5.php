...
$query_auth = "SELECT * FROM Harris_10 where ID like '$ggc' or name like '$ggc'";
...
<a href="param1.php">Identification and Positional Data</a></i>
</td>
...
echo '<a href="param2_10.php">Metallicity and Photometry</a> </i>';
echo '</td></tr>';
  }
...
echo '<tr>';
echo '<td colspan=2 align=CENTER BGCOLOR="#66FFCC"><i>';
echo '<a href="param3_10.php">Velocity and Structural Parameters</i>';
echo '</td></tr>';
  }
